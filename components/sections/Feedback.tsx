...
const Feedback = () => (
  <section className="sm:p-16 xs:p-8 px-6 py-12 relative z-10">
    ...
    >
      ...
      >
        <Image src="/planet-09.png" alt="rocket flying between planets" height={900} width={1920} className="w-full lg:h-[610px] h-auto min-h-[210px] object-cover rounded-[40px]" />
        <motion.div
          variants={zoomIn(0.4, 1)}
          className="lg:block hidden absolute -left-[10%] top-[3%]"
        >
          <Image src="/stamp.png" alt="stamp" height={200} width={200} className="w-[155px] h-[155px] object-contain" />
        </motion.div>
      </motion.div>
    </motion.div>
  </section>
